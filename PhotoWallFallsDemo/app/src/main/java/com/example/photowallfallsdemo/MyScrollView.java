...
public class MyScrollView extends ScrollView implements View.OnTouchListener {
    ...
    /**
     * 是否已经加载过一次layout,这里的onlayout只需加载一次
     */
    ...
    /**
     * 进行一些关键的初始化操作，获取MyScrollView的高度，以及得到第一列的宽度值。并且在这里开始加载第一页的图片.
     */
    @Override
    ...
    /**
     * 遍历imageViewList中的每张图片，对图片的可见性进行检查，如果图片已经离开屏幕的可见范围，则将图片替换成一张空图。
     */
